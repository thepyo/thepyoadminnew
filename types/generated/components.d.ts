...
export interface HomepageSlideMobile extends Schema.Component {
  collectionName: 'components_homepage_slide_mobiles';
  info: {
    displayName: 'slide_mobile';
    description: '';
  };
  attributes: {
...
export interface HomepageHomepageTags extends Schema.Component {
  collectionName: 'components_homepage_homepage_tags';
  info: {
    displayName: 'homepage_tags';
  };
  attributes: {
    title: Attribute.String;
    description: Attribute.Text;
...
declare module '@strapi/types' {
  export module Shared {
    export interface Components {
      ...
      'seo.seo': SeoSeo;
      'menu.menu': MenuMenu;
      'homepage.slide-mobile': HomepageSlideMobile;
      'homepage.homepage': HomepageHomepage;
      'homepage.homepage-tags': HomepageHomepageTags;
